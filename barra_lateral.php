	...
	<body>
		<div class="BarraLateral">
			<ul><!--Se encuentran los links a las demas paginas-->
				...
				<li><a href="productos_tabla_correspondencia.php">• Llegada de correspondencia</a></li>
				<li><a href="categoria_tabla_correspondencia.php">• Captura de empresas (correspondencia)</a></li>
				<li><a href="datos_bsf_correspondencia.php">• Entrega correspondencia</a></li>
