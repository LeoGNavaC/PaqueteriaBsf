...
//*******************************************************se realizo modificacion******************************************
    ...
    if (isset($_GET['pag']) && isset($_GET['categoria'])) {
        ...
        if ($id > 0) {
            $query = "DELETE FROM categoria_productos_correspondencia WHERE id=?";//***************se realizo modificacion */
            ...
            if ($result) {
                ...
                header("Location: categoria_tabla_correspondencia.php?pag=$pagina");//************se realizo modificacion */
                exit();
            } else {
