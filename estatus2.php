<!--No se entrego al titular y no se encontro nadie-->
<?php 
		...
		<div class="caja_popup4">
			<form class="contenedor_popup3" method="POST">
				<table>
					...
					<tr>
    					<td><b>Escribe: </b></td>
						<td><textarea class="CajaTexto" type="text" name="fue" style="width: 383px; height: 201px;"  required><?php echo $proest;?></textarea></td>
